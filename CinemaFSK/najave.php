...
<head>
<title>Cinema World | Najave</title>
      ...
      <div id="header">
        ...
        <div class="row-2">
          <ul>
            ...
            <li><a href="najave.php" class="active">Najave</a></li>
        ...
        <div class="box">
          <div class="border-right">
            <div class="border-left">
              <div class="inner">
                <h3>Uskoro u  <span>Cinema FSK</span></h3>
                <div class="content">
                  <h3>Uskoro u <span>kinu</span></h3>
                  <ul class="list">
                    <?php
                    $sql_film = "SELECT * FROM filmovi WHERE status='uskoro'";
